...
import static com.example.solidconnection.support.fixture.UniversityInfoForApplyFixture.괌대학_A_지원_정보;
import static com.example.solidconnection.support.fixture.UniversityInfoForApplyFixture.괌대학_B_지원_정보;
import static com.example.solidconnection.support.fixture.UniversityInfoForApplyFixture.그라츠공과대학_지원_정보;
import static com.example.solidconnection.support.fixture.UniversityInfoForApplyFixture.그라츠대학_지원_정보;
import static com.example.solidconnection.support.fixture.UniversityInfoForApplyFixture.네바다주립대학_라스베이거스_지원_정보;
import static com.example.solidconnection.support.fixture.UniversityInfoForApplyFixture.린츠_카톨릭대학_지원_정보;
import static com.example.solidconnection.support.fixture.UniversityInfoForApplyFixture.메모리얼대학_세인트존스_A_지원_정보;
import static com.example.solidconnection.support.fixture.UniversityInfoForApplyFixture.메이지대학_지원_정보;
import static com.example.solidconnection.support.fixture.UniversityInfoForApplyFixture.서던덴마크대학교_지원_정보;
import static com.example.solidconnection.support.fixture.UniversityInfoForApplyFixture.코펜하겐IT대학_지원_정보;
...
class UniversityQueryServiceTest2 {
    ...
    private final UniversityInfoForApply 괌대학_A_지원_정보 = 괌대학_A_지원_정보();
    private final UniversityInfoForApply 괌대학_B_지원_정보 = 괌대학_B_지원_정보();
    private final UniversityInfoForApply 네바다주립대학_라스베이거스_지원_정보 = 네바다주립대학_라스베이거스_지원_정보();
    private final UniversityInfoForApply 메모리얼대학_세인트존스_A_지원_정보 = 메모리얼대학_세인트존스_A_지원_정보();
    private final UniversityInfoForApply 서던덴마크대학교_지원_정보 = 서던덴마크대학교_지원_정보();
    private final UniversityInfoForApply 코펜하겐IT대학_지원_정보 = 코펜하겐IT대학_지원_정보();
    private final UniversityInfoForApply 그라츠대학_지원_정보 = 그라츠대학_지원_정보();
    private final UniversityInfoForApply 그라츠공과대학_지원_정보 = 그라츠공과대학_지원_정보();
    private final UniversityInfoForApply 린츠_카톨릭대학_지원_정보 = 린츠_카톨릭대학_지원_정보();
    private final UniversityInfoForApply 메이지대학_지원_정보 = 메이지대학_지원_정보();

    @BeforeEach
    void setUp() {
        universityFixtureHelper.모든_대학_정보_생성();
        universityInfoForApplyRepository.saveAll(List.of(
                괌대학_A_지원_정보, 괌대학_B_지원_정보, 네바다주립대학_라스베이거스_지원_정보, 메모리얼대학_세인트존스_A_지원_정보,
                서던덴마크대학교_지원_정보, 코펜하겐IT대학_지원_정보,
                그라츠대학_지원_정보, 그라츠공과대학_지원_정보, 린츠_카톨릭대학_지원_정보, 메이지대학_지원_정보
        ));
    }
